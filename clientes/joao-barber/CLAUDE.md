...
| `ACORDO-DADOS.md` | Acordo de operador entre Miguel e João (art. 39 da LGPD). **Rascunho, ainda não assinado.** Quando assinar, guardar o PDF ao lado com o nome `ACORDO-DADOS-assinado.pdf` |
